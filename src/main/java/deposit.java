                 ...
                 if(rs2.next())
                 {
                	 ...
                	 else
                	 {
                		 if(dbpin==pin)
                		 {
                				    ...
                				    String query4 = "INSERT INTO transcations(Customer_id,fromCardNo,toCardNumber,Transcation_type,Amount,Transcation_date) values('"+customerID+"','"+cardNo+"','self','Deposit','"+amount+"',Now())";
                				    stmt.executeUpdate(query4);

                				    
                       			 response.sendRedirect("users/depositSuccess.jsp"); 
