    ...
    <br><br>
        ...
        <form action="viewProfile" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="name" name="name" class="form-control" value="<%= request.getAttribute("name") %>" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="password" id="password" name="password" class="form-control" value="<%= request.getAttribute("password") %>" readonly>
            </div>
        </form>
    </div>
